...
short src_ln0 [] = {
	  0,   9,  10,  13,  15,  15,  16,  17, 
	 18,  19,  12,  23,  12,  23,  24,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "gcd_model.pml", 1, 14 },
	{ "-", 15, 16 }
...
{	int j = 0, h = now._nr_pr;
	...
	case 0:	/* GCD */
		...
		((P0 *)pptr(h))->result = 0;
#ifdef VAR_RANGES
		logval("GCD:a", ((P0 *)pptr(h))->a);
		logval("GCD:b", ((P0 *)pptr(h))->b);
		logval("GCD:result", ((P0 *)pptr(h))->result);
		logval("GCD:temp", ((P0 *)pptr(h))->temp);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
printm(int x, char *s)
{
	...
	case 2: Printf("gcd"); return;
	case 3: Printf("start"); return;
